package com.xlbs.importexportservice.datasource;

public class DataSourceConstants {
	
	//MySQL数据库
	public final static String MYSQL_SCAN_PACKAGE="com.xlbs.apiservice.dao";
	public final static String MYSQL_SCAN_MAPPER="classpath:/mybatis-mapper/**/*.xml";
